...
package pl.itgolo.libs.chromium.Scenes.Detailed;
...
public class MainFrame extends JFrame {
    ...
    public ControlPanel control_pane_;
    ...
    public MainFrame(boolean osrEnabled, String cookiePath, String[] args) {
        ...
        MessageRouterHandler messageRouterHandler = new MessageRouterHandler(){
            ...
            public boolean onQuery(CefBrowser browser, long query_id, String request, boolean persistent, CefQueryCallback callback) {
                ...
                return super.onQuery(browser, query_id, request, persistent, callback);
            }
        };
        ...
        browser_ = client_.createBrowser("about:blank",
                osrEnabled,
                false,
                requestContext);
